...
(function() {
  var Sky, Star, canvas, center_x, center_y, ctx, diff_x, diff_y, div, draw_sky, fps, height, i, last_frame, max_radius, max_size, ms_per_frame, random_star, requestAnimationFrame, retinafy, sky, speed, star_number, stars, width, wrapper_id;
  ...
  Sky = (function() {
    ...
    Sky.prototype.clear = function(ctx) {
      ctx.fillStyle = 'black';
      return ctx.fillRect(this.x_lower, this.y_lower, this.w, this.h);
    };
